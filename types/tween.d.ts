import { Quat, Vec4, Vec3, Vec2 } from 'playcanvas'

declare global {
    // Taken from https://github.com/playcanvas/playcanvas-tween/blob/main/index.d.ts
    // NOTE(matt): Caveat; This will need to be updated as playcanvas tween index.d.ts is updated.
    namespace pc {
